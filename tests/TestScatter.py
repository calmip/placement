...
class TestScatterExclusive(unittest.TestCase):
    def setUp(self):
        ...
        self.scatter_ko5 = ScatterMode(self.exclu_ko5)
        ...
        self.scatter_ko7 = ScatterMode(self.exclu_ko7)
        ...
        self.scatter_ko10 = ScatterMode(self.exclu_ko10)
        ...
        self.scatter_ko15 = ScatterMode(self.exclu_ko15)
